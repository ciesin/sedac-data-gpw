...
#
# Script checks whether any entire features in a country's boundaries (CAN USE THIS ONE FOR THE 5 BIG COUNTRIES)
...
# set counter
    ...
    diagnosticTable = r'\\Dataserver0\gpw\GPW4\Gridding\global\inputs\validation\watermask_3_20_15_bra.csv'
...
##    workspace = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs'
    workspace  = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs\rus_area\inputs'
