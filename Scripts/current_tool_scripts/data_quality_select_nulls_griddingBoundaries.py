...
gdbList = arcpy.ListWorkspaces("*mmr*","FileGDB")
gdbList.sort()


# define csv file
##output =r'\\Dataserver0\gpw\GPW4\Gridding\validation\data_quality.csv'
output =r'C:\Users\edwhitfi\Desktop\Notes and Instruction\Python\GPW\Selecting_Null_units_data_quality\data_quality_null_griddingBoundaries.csv'
