...
workspace = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs\rus_area'
...
gdbList = arcpy.ListWorkspaces("rus.gdb","FileGDB")
gdbList.sort()
print gdbList
...
##        griddingList = arcpy.ListFeatureClasses("*boundaries_gridding")
