...
output =r'C:\Users\edwhitfi\Desktop\Notes and Instruction\Python\GPW\Selecting_Null_units_data_quality\data_quality_zero_griddingBoundaries.csv'

# open csv file and write header
csvFile = csv.writer(open(output,'wb'))
csvFile.writerow(("COUNTRYISO","gridding_count","gridding_Zero_count", "new_gridding_ero_count"))
...
##            out_gdb_path = r'C:\Users\edwhitfi\Desktop\Notes and Instruction\Python\GPW\Selecting_Null_units_data_quality\zero_features\test_zero.gdb'
            out_gdb_path = r'\\Dataserver0\gpw\GPW4\Gridding\global\data_quality\zero_features\zero_features.gdb'
