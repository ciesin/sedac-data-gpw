...
inFC = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs\ala.gdb\ala_admin1_boundaries_2010'
waterExist = " true "
# binary flag to indicate whether growth rate has been calculated
grCalc = " false "
workspace = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs\ala.gdb'
