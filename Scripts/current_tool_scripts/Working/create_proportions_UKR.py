...
inputTable = r"\\Dataserver0\gpw\GPW4\Gridding\country\inputs\ukr.gdb\UKR_admin2_census_2001"
##outputTable = arcpy.GetParameterAsText(1)
outputTable = r"\\Dataserver0\gpw\GPW4\Gridding\country\inputs\ukr.gdb"
