...
# Define workspace
workspace = r'\\Dataserver0\gpw\GPW4\Preprocessing\Country\KEN\Ingest\Boundary\boundary_adjustment_v3.gdb'
env.workspace = workspace
# Define Framework Boundaries
frameworkBoundaries =  r'\\Dataserver0\gpw\GPW4\Preprocessing\Country\KEN\Ingest\Boundary\boundary_adjustment_v3.gdb\KEN_admin0_add_SSD_IlemiTriangle'
...
inputBoundaries = r'\\Dataserver0\gpw\GPW4\Preprocessing\Country\KEN\Ingest\Boundary\boundary_adjustment_v3.gdb\KenyaSubLocations_SpatialAdjust_WGS84_index'
...
try:
    ...
    arcpy.CalculateField_management(inputBoundaries,FRAMEWORKID,"!" + "OBJECTID_1" +"!","PYTHON")
...
try:
    ...
    arcpy.CalculateField_management(clipBoundaries,CLIPID,"!" + "OBJECTID_1" +"!","PYTHON")
...
try:
    ...
    arcpy.CalculateField_management(intersectSym,INTRSCTID,"!" + "OBJECTID_1" + "!","PYTHON")
