...
# define input table
inTable = r"\\Dataserver0\gpw\GPW4\Gridding\country\inputs\alb.gdb\ALB_proportions"
inTable = arcpy.GetParameterAsText(0)
# define output workspace
outWS = r"\\Dataserver0\gpw\GPW4\Gridding\country\inputs\alb.gdb"
outWS = arcpy.GetParameterAsText(1)
# define growth rate table
grTable = r"\\Dataserver0\gpw\GPW4\Gridding\country\inputs\alb.gdb\ALB_growth_rate_admin3"
