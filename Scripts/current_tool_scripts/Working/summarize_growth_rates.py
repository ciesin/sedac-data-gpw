...
summaryTemplate = r'\\Dataserver0\gpw\GPW4\Gridding\global\inputs\merged_files.gdb\growth_rates_schema'
# create copy of summary template
summaryTable = r'\\Dataserver0\gpw\GPW4\Gridding\global\inputs\merged_files.gdb' + os.sep + "growth_rates_summary"
...
for table in tables:
    ...
    for field in fields:
        ...
        if len(fieldCheck) == 1:
##            variablePresence = "1"
            # create search cursor to find fields value
            # create updateCursor
