...
##        print "Copied the country-level boundary from GADMv2.  This is the highest resolution for GADMv2."
##    else:
##        print "suffix = " + suffix
##        arcpy.CopyFeatures_management(gadmAdminWS + os.sep + "gadm2_admin0.gdb" + os.sep + iso,
##                                  gadm2GDB + os.sep + iso + "_admin0")
##        print "Copied the country-level boundary from GADMv2"
##        arcpy.CopyFeatures_management(gadmAdminWS + os.sep + "gadm2_country.gdb" + os.sep + iso,
##                                  gadm2GDB + os.sep + iso + "_admin" + suffix)
##        print "Copied the " + suffix + "-level boundary from GADMv2"

    arcpy.CopyFeatures_management(gadmAdminWS + os.sep + "gadm2_admin0.gdb" + os.sep + iso,
                                  gadm2GDB + os.sep + iso + "_admin0")
    print "Copied the country-level boundary from GADMv2."
    suffixList = ["1","2","3","4","5","6","7"]
    if suffix in suffixList:
        print "Suffix is in suffixList"
        arcpy.CopyFeatures_management(gadmAdminWS + os.sep + "gadm2_country.gdb" + os.sep + iso,
                                  gadm2GDB + os.sep + iso + "_admin" + suffix)
        print "Copied the country-level boundary from GADMv2"
    else:
        print "This is the highest resolution for GADMv2."
        pass
