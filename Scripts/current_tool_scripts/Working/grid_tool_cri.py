...
outputRoot = r'\\Dataserver0\gpw\GPW4\Paper\Figures_and_Tables\data\grids'
...
# Project Data
# Input Fishnet
fish = r'\\Dataserver0\gpw\GPW4\Paper\Figures_and_Tables\data\CRI_GPWv4_A000.gdb\cri_fishnet'
# Coordinate System
