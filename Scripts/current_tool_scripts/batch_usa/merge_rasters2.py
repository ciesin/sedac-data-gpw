...
# List Rasters
rasters = arcpy.ListRasters("*ATOTPOPBT_ADMIN")
for raster in rasters:
    ...
    while x:
        ...
        i = i + 1
        x = x - 1
    outCellStats = r'E:\gpw\usa_state\usa_grids.gdb' + os.sep + name + suffix
    rastList = str(raster)
...
##                                               "1", "FIRST","FIRST")
    ...
    outCellStats = r'E:\gpw\usa_state\usa_grids.gdb\USA' + suffix
