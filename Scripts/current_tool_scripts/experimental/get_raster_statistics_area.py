...
# define csv file
attributes = r'\\dataserver0\gpw\GPW4\Gridding\validation' + os.sep + "area_stats_9_15_14.csv"
...
for gdb in gdbs:
    ...
    variables = arcpy.ListRasters("*_AREA*")
    for variable in variables:
        VARIABLE = variable
        # run zonalstats
        zstat = r'\\Dataserver0\gpw\GPW4\Gridding\validation\area_diagnostics.gdb' + os.sep + VARIABLE + "_statistics"
