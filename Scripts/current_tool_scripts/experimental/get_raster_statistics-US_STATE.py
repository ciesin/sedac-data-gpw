...
# define csv file
attributes = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs\usa_state\validation' + os.sep + "usa_raster_stats_8_28_14_v1.csv"
...
for gdb in gdbs:    
    ...
    files = arcpy.ListRasters("*_ATOTPOPBT_2*")
    for f in files:
        FILE = f
        split = FILE.split("_")
        ISO = split[0]
        ...
        # run zonalstats
        zstat = r'\\dataserver0\gpw\GPW4\Gridding\country\inputs\usa_state\validation\atotpopbt_diagnostics.gdb' + os.sep + f + "_statistics"
