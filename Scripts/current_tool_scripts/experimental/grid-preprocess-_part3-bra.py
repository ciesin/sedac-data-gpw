...
##    inFC = r'D:\GPW\mar.gdb\mar_admin3_boundaries_2010'
    inFC = r'E:\gpw\bra\bra.gdb\bra_admin5_boundaries'#arcpy.GetParameterAsText(0)
    
##    workspace = r'D:\GPW\mar.gdb'
    waterExist = "true"#arcpy.GetParameterAsText(1)
    grCalc = "true"#arcpy.GetParameterAsText(2)
    workspace = r'E:\gpw\bra\bra.gdb'#arcpy.GetParameterAsText(3)
    useISO = "true"#arcpy.GetParameterAsText(4)
