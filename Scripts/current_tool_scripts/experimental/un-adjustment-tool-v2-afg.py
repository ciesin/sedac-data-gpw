...
# define input table
inTable = r"\\Dataserver0\gpw\GPW4\Gridding\country\inputs\afg.gdb\afg_estimates"
##inTable = arcpy.GetParameterAsText(1)
# define output workspace
##outWS = r"\\Dataserver0\gpw\GPW4\Gridding\Country\inputs\npl.gdb"
outWS = r"\\Dataserver0\gpw\GPW4\Gridding\country\inputs\afg.gdb"#arcpy.GetParameterAsText(2)
