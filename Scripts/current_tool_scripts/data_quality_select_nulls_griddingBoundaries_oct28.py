...
output =r'C:\Users\edwhitfi\Desktop\Notes and Instruction\Python\GPW\Selecting_Null_units_data_quality\data_quality_null_griddingBoundaries_oct28.csv'
...
for gdb in gdbList:
    ...
    if iso.startswith(('kir'))== False:
        ...
        out_features = r'C:\Users\edwhitfi\Desktop\scratch\data_quality\inputs' + os.sep + iso + "gridding_test_oct28.dbf"
