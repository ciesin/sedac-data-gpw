...
#   5) No. of pixels in the fishnet that have <NULL> (by year), CNT and CNTM***
#   5a) No. of pixels in the fishnet that have Zero (by year), CNT and CNTM***

#       To check if there are any countreis that do not fit the above situations, yet still have <NULL> values in fishnet.  
...
csvFile.writerow(("COUNTRYISO","INPUTPOP_UNITS_COUNT","BOUNDARY_GRIDDING_FC_COUNT","DIFFERENCE",
                  ...
                  "NUM_NULL_FISHNET_CNT","NUM_NULL_FISHNET_CNTM","NUM_ZERO_FISHNET_CNT","NUM_ZERO_FISHNET_CNTM",
...
for gdb in gdbList:
    ...
    if iso.startswith(('a','bd','be','bf','bg','bh','bl','bm','bo','br','btn','chn','kir'))== False:
    ...
    # Print data for that gdb
        csvFile.writerow((iso,inputCensus_count,gridding_count,diff,
                          ...
                          fishnet_Null_CNT_count,fishnet_Null_CNTM_count,fishnet_Zero_CNT_count,fishnet_Zero_CNTM_count,
