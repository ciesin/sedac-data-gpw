...
# define inputs
inFC = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs\slv_redo.gdb\slv_admin2_boundaries_2010'
...
workspace = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs\slv_redo.gdb'
...
print "Project file is:" + prjFile
# check to see that Project File exists, if it doesn't kill the script
