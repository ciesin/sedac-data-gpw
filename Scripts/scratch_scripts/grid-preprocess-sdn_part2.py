...
def main():
    ...
    # define inputs
    inFC = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs\sdn.gdb\sdn_admin3_boundaries_2010'
    ##inFC = arcpy.GetParameterAsText(0)
    ##workspace = arcpy.GetParameterAsText(1)
    workspace = r'\\Dataserver0\gpw\GPW4\Gridding\country\inputs\sdn.gdb'
