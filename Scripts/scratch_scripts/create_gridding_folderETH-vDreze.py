...
# define input ISO
isoText = "ETH"#arcpy.GetParameterAsText(0)
iso = isoText.lower()
##iso = "bvt"
print iso
...
##        pass
    ...
    # Input parameters
    censusTable = r'\\Dataserver0\gpw\GPW4\Preprocessing\Country\ETH\Ingest\Census\ETH_10.gdb\eth_census_2007_ingest'#arcpy.GetParameterAsText(1)
    lookupTableExist = "false"#arcpy.GetParameterAsText(3)
    lookupTable = r'\\Dataserver0\gpw\GPW4\Preprocessing\Country\ETH\Ingest\Census\ETH_10.gdb\eth_lookup_admin3'#arcpy.GetParameterAsText(2)
    
    growthRateTableExist = "true"#arcpy.GetParameterAsText(4)
    growthRateTable = r'\\Dataserver0\gpw\GPW4\Preprocessing\Country\ETH\Ingest\Census\ETH_10.gdb\eth_growth_rate_final'#arcpy.GetParameterAsText(5)    
    boundaryFC = r'\\Dataserver0\gpw\GPW4\Preprocessing\Country\ETH\Ingest\Boundary\boundary_adjustment.gdb\eth_admin3_2010'#arcpy.GetParameterAsText(6)
    levelNumber = "3"#arcpy.GetParameterAsText(7)
...
# Create UCIDs (add zeros to UCADMINs)
    ...
    for field in fields:
        ...
        try:
            arcpy.CalculateField_management(scratchCensusTable,calculationField,calculationExpression,"PYTHON","#")
