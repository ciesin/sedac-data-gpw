...
grCalc = "true"
# define input table
inTable = r"\\Dataserver0\gpw\GPW4\Gridding\UN_adjustments\glp_maf_blm.gdb\process_estimates"
##inTable = arcpy.GetParameterAsText(1)
# define output workspace
outWS = r"\\Dataserver0\gpw\GPW4\Gridding\UN_adjustments\glp_maf_blm.gdb"
...
try:
    ...
    arcpy.TableSelect_analysis(inUNTable,unTable,'"UCID0" = ' + "'" + "312" + "'")
