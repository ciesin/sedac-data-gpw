...
# define input table
inTable = r"\\Dataserver0\gpw\GPW4\Gridding\country\fra_edw.gdb\FRA_proportions"
##inTable = arcpy.GetParameterAsText(0)
# define output workspace
outWS = r"\\Dataserver0\gpw\GPW4\Gridding\country\fra_edw.gdb"
##outWS = arcpy.GetParameterAsText(1)
# define growth rate table
grTable = r"\\Dataserver0\gpw\GPW4\Gridding\country\fra_edw.gdb\fra_growth_rate_admin45_2009"
