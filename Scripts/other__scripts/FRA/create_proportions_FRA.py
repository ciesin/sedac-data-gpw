...
inputTable = r"\\Dataserver0\gpw\GPW4\Gridding\country\fra_edw.gdb\FRA_mix4_5_census_2009"
##outputTable = arcpy.GetParameterAsText(1)
outputTable = r"\\Dataserver0\gpw\GPW4\Gridding\country\fra_edw.gdb\FRA_proportions"
...
if calcAgeGroups == "true":
    ...
    for fieldPossibility in fieldPossibilities:
        ...
        if len(fList)>0:
            ...
            print fieldPossibility + " does not exist in table"
...
##            arcpy.AddMessage("Added " + newField)
        ...
        expression = '"' + field + '" <> -9999 AND ' + '"' + field + '" <> 0'
        try:
