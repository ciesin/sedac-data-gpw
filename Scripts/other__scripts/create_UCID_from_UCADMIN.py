...
if censusAdminLevel == "0":
    ...
    deleteFields = ["UTCID0","UTCID1","UTCID2","UTCID3","UTCID4","UTCID5","UTCID6"]
else:
    pass
...
for deleteField in deleteFields:
    # Create condition to check if field already exists, if it does delete it
    fieldExistList = arcpy.ListFields(censusTable, deleteField)
    if len(fieldExistList) == 1:
        arcpy.DeleteField_management(censusTable,deleteField)
        print "Deleted " + deleteField
    else:
        print deleteField + " didn't exist"
