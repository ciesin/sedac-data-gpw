...
custom = imp.load_source('custom',r'\\Dataserver0\gpw\GPW4\Release_4_0\Prod\Scripts\python\functions\validateSchema.py')
# import the print_and_log_msg from output-logger
log = imp.load_source('log',r'\\Dataserver0\gpw\GPW4\Release_4_0\Prod\Scripts\python\functions\output-logger.py')

# set time counter
startTime = datetime.datetime.now()
        
# define gridding folder workspace
workspace = r'\\Dataserver0\gpw\GPW4\Release_4_0\Prod\Gridding\country\pop_tables'
arcpy.env.workspace = workspace

# define location of schema tables
schemas = r'\\Dataserver0\gpw\GPW4\Release_4_0\Prod\Gridding\schema_tables.gdb'
...
if runFromToolBox:
    ...
    isoText = "POL"
    inputPopTable = r'\\Dataserver0\gpw\GPW4\Release_4_1\Alpha\Preprocessing\Country\POL\Ingest\Census\POL_admin4_census_2011.xlsx'
    ingestPopTab = 'POL_admin4_census_2011'
    ingestPopLevel = 4
    estimateYear = "2011"
    yearField = "CENSUS_YEAR"
    inputSexTable = r'\\Dataserver0\gpw\GPW4\Release_4_1\Alpha\Preprocessing\Country\POL\Ingest\Census\POL_admin4_census_2011.xlsx'
    ingestSexTab = "POL_admin4_census_2011"
    ingestSexLevel = 4
    inputAgeTable = None
    ingestAgeTab = None
    ingestAgeLevel = None
    ...
    lookUpTable = r'\\Dataserver0\gpw\GPW4\Release_4_1\Alpha\Preprocessing\Country\POL\Match\POL_lookup_admin4.xlsx'
    lookUpTab = 'POL_lookup_admin4'
...
logfile = r'\\Dataserver0\gpw\GPW4\Release_4_0\Prod\Gridding\country\script_outputs' + os.sep + iso + logtime + ".txt"
# now initiliaze file
lf = open(logfile,'w')
...
for description, table in tables.iteritems():
    ...
    if custom.checkForField(outPop1Tbl,'ISO')==0:
        try:
            arcpy.AddField_management(outPop1Tbl,'ISO','TEXT','#','#',20)
