...
if runFromToolBox:
    ...
    isoText = "EGY"
    inputPopTable = r'\\Dataserver0\gpw\GPW4\Release_4_0\Prod\Preprocessing\EGY\Ingest\Census\egy_admin2_ingest_2006.xlsx'
    ingestPopTab = 'egy_admin2_census_2006'
    ingestPopLevel = 2
    estimateYear = "2006"
    yearField = "CENSUS_YEAR"
    inputSexTable = r'\\Dataserver0\gpw\GPW4\Release_4_0\Prod\Preprocessing\EGY\Ingest\Census\egy_admin2_ingest_2006.xlsx'
    ingestSexTab = "egy_admin2_census_2006"
    ingestSexLevel = 2
    inputAgeTable = None
    ingestAgeTab = None
    ingestAgeLevel = None
    ...
    lookUpTable = r'\\Dataserver0\gpw\GPW4\Release_4_0\Prod\Preprocessing\EGY\Match\egy_admin2_match.xlsx'
    lookUpTab = 'egy_lookup_admin2'
