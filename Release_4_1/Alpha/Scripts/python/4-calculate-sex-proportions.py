# this script calculates the sex proportions table
# because Total Males + Total Females does not necessarily equal
...
def main():
    ...
    for ws in workspaces:
        ...
        gdbs = arcpy.ListWorkspaces('pol*',"FILEGDB")
        gdbs.sort()
