...
def intersect(shp):
    ...
    # define output files
    outSWBD = r'D:\gpw\release_4_1\water\water_inputs\intersected_swbd_v2' + os.sep + iso + '_swbd_intersect.shp'
    outGLIMS = r'D:\gpw\release_4_1\water\water_inputs\intersected_glims_v2' + os.sep + iso + '_glims_intersect.shp'
    try:
...
def main():
    ...
    inWS = r'\\Dataserver0\gpw\GPW4\Release_4_1\Alpha\Gridding\global\boundaries\country_boundaries_admin0.gdb'
    ...
    for fc in fcs:
        if fc[:3] in isos:
            fcList.append(os.path.join(inWS, fc))
