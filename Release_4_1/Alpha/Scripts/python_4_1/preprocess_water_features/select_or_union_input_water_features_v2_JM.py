...
def processCountries(iso):
    ...
    boundaryWaterFeatures = r'D:\gpw\release_4_1\water\water_inputs\boundary_water_features_v2' + os.sep + iso + "_boundary_water_features.shp"
    nmasWaterFeatures = r'D:\gpw\release_4_1\water\water_inputs\nmas_water_features' + os.sep + iso + "_nmas_water_features.shp"
    intersectedGlims = r'D:\gpw\release_4_1\water\water_inputs\intersected_glims_v2' + os.sep + iso + "_glims_intersect.shp"
    intersectedSWBD = r'D:\gpw\release_4_1\water\water_inputs\intersected_swbd_v2' + os.sep + iso + "_swbd_intersect.shp"
    unionedBoundaryWaterFeatures = r'D:\gpw\release_4_1\water\water_outputs\unioned_boundary_water_features_v2' + os.sep + iso + ".shp"
    unionedGLIMS = r'D:\gpw\release_4_1\water\water_outputs\unioned_glims_v2' + os.sep + iso + ".shp"
    # output features
    maskFolder = r'D:\gpw\release_4_1\water\water_outputs\water_masks_v2'
    finalOutputFeatures = r'D:\gpw\release_4_1\water\water_outputs\water_masks_v2' + os.sep + iso + "_water_mask.shp"
...
##    print fcList
    ...
    results = pool.map(processCountries, isos)
    for r in results:
        print r
