...
##    return ageProportions
    ...
    ageExpression = "!A000_014BT!+!A065PLUSBT!+!A015_064BT!"
...
##        return returnList
        ...
        try:
            ...
            return (iso + ' error: on age proportions calculation')
...
def main():
    ...
    procList = arcpy.ListWorkspaces("blr*")
    print "processing"
