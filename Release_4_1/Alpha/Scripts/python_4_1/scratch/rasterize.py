...
workspace = r"D:\gpw\release_4_1\scratch"  # Update
outWS = r"D:\gpw\release_4_1\scratch" # Update
# Create driver to produce GeoTiffs
driver = gdal.GetDriverByName( "GTiff" )

# Define input extent
inputExtent = r"D:\gpw\ancillary\gpw4_extent.tif"
# Open Extent File
...
shps = arcpy.ListFeatureClasses("*black_sea*")
