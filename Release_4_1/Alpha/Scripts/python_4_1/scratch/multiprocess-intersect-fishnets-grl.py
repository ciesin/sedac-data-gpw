...
##            fishnet = outFish
##    except:
##        return iso + " error processing fishnet for PIXELAREA"
    try:
        ...
        if arcpy.Exists(waterFC):
            ...
            arcpy.CalculateField_management(inFC + "_intersect","WATERAREAKM",0,"PYTHON")
            arcpy.CalculateField_management(inFC + "_intersect","AREAKMMASKED","!AREAKM!","PYTHON")
        # success
...
def main():
    ...
    gdbs= arcpy.ListWorkspaces("grl_*","FILEGDB")
