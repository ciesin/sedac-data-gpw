    ...
    if len(estList) == 1:
        ...
        for f in fields:
            if not "TOTPOP" in f.name:
                ...
                arcpy.AddField_management(estMem,f.name[:-7]+"BT_2010","DOUBLE")
        ...
        if topAge > 65:
            for i in reversed(range(65,topAge,5)):
                ...
                arcpy.AddField_management(estMem,ageFields[0],"DOUBLE")
                arcpy.AddField_management(estMem,ageFields[1],"DOUBLE")
                arcpy.AddField_management(estMem,ageFields[2],"DOUBLE")
        ...
        arcpy.AddField_management(estMem,"E_A000_014BT_2010","DOUBLE")
        arcpy.AddField_management(estMem,"E_A015_064BT_2010","DOUBLE")
        arcpy.AddField_management(estMem,"E_A015_049FT_2010","DOUBLE")
        ...
        arcpy.CopyRows_management(estMem,estTable)
        print iso+": copied out"
