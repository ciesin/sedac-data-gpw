...
outFolder = r'\\Dataserver0\gpw\GPW4\Release_4_1\Alpha\Gridding\centroids'
csvFolder = os.path.join(outFolder,'csv')
shpFolder = os.path.join(outFolder,'shp')
gpkgFolder = os.path.join(outFolder,'gpkg')
...
for iso in isoList:
    ...
    arcpy.FeatureClassToFeatureClass_conversion(fcPath,shpFolder,iso+'_centroids.shp')
    ...
    arcpy.FeatureClassToFeatureClass_conversion(outFC,outFile,iso+"_centroids")
