...
estimatesSummaryTable = r'F:\gpw\ancillary.gdb\estimates_summary_2_18_2016'
if not arcpy.Exists(estimatesSummaryTable):
    inWS = r'F:\gpw\pop_tables'    
    ...
    ##        print "processing " + os.path.basename(workspace)
        ...
        # define workspace environment, grab the estimates summary table and add to list
        arcpy.env.workspace = workspace
        # grab table
        summaryTable = arcpy.ListTables("*estimates_summary")[0]
        summaryTables.append(workspace+os.sep+summaryTable)
    # merge the summary tables  
    arcpy.Merge_management(summaryTables,estimatesSummaryTable)
    print "Created " + estimatesSummaryTable

# define input wpp table
wppTableIn = r'F:\gpw\ancillary.gdb\un_wpp2015'
# copy of this
wppTable = r'F:\gpw\ancillary.gdb\un_wpp2015_adjustment_factors_2_18_16'
# define groupLookup
groupLookupTable = r'F:\gpw\ancillary.gdb\un_wpp2015_group_lookup'
...
##                print "Created " + estimatesView
                ...
                with arcpy.da.SearchCursor(estimatesView,["SUM_E_ATOTPOPBT_1975","SUM_E_ATOTPOPBT_1990","SUM_E_ATOTPOPBT_2000",
                       "SUM_E_ATOTPOPBT_2005","SUM_E_ATOTPOPBT_2010","SUM_E_ATOTPOPBT_2015","SUM_E_ATOTPOPBT_2020"]) as estimatesRows:
