...
if runFromToolBox:
    ...
    isoText = "JRS"
    inputPopTable = r'\\Dataserver0\gpw\GPW4\Beta\Gridding\country\inputs\agoTEST.gdb\ago_admin2_2014_population'
    ingestPopTab = None
    ingestPopLevel = 2
    estimateYear = "2010"
    yearField = "CENSUS_YEAR"
    inputSexTable = r'\\Dataserver0\gpw\GPW4\Beta\Scripts\python\test_inputs\ALB_admin1_census_2011.xlsx'
    ingestSexTab = "ALB_admin1_census_2011"
    ingestSexLevel = 1
    inputAgeTable = None
    ingestAgeTab = None
    ingestAgeLevel = None
