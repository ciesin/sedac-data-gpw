...
##        print arcpy.GetMessages()
    ...
    for year in targetYears:
        ...
        if len(arcpy.ListFields(estimatesTable,eField))==0:
            try:
                arcpy.AddField_management(estimatesTable,eField,"LONG")
            except:
                arcpy.GetMessages()
            # construct calcExpression
            calcExpression = "!ATOTPOPBT! * math.exp( float(!agr! * " + yearTo + "))"
            ...
            print gdb + " already contains 1990 estimate"
