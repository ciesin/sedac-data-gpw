...
# parse rootName
rootName = workspace + os.sep + iso + '.gdb' + os.sep + iso + '_admin' + adminLevel + '_' + grStartYear + '_' + grEndYear
...
agrInput = r'\\Dataserver0\gpw\GPW4\Beta\GrowthRate\beta_csvs' + os.sep + iso + '.csv'
# make a table view of the input file
agrInputView = iso + '_growth_rate_view'
try:
...
try:
    ...
    print arcpy.GetMessages()
try:
    arcpy.Append_management(agrOutTbl,outPopTable,'NO_TEST')
except:
    print arcpy.GetMessages() 
