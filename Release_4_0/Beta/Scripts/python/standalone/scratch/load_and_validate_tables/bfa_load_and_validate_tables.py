...
if runFromToolBox:
    ...
    isoText = "BFA"
    inputPopTable = r'\\Dataserver0\gpw\GPW4\Beta\Preprocessing\Country\BFA\Ingest\Census\bfa_census_2006_ingest.xlsx'
    ingestPopTab = "bfa_admin3_census_2006"
    ingestPopLevel = 3
    estimateYear = "2016"
    yearField = "CENSUS_YEAR"
    inputSexTable = inputPopTable
    ingestSexTab = "bfa_admin3_census_2006"
    ingestSexLevel = 3
    inputAgeTable = None
    ingestAgeTab = None
    ingestAgeLevel = None
    ...
    lookUpTable = r'\\Dataserver0\gpw\GPW4\Beta\Preprocessing\Country\BFA\Match\bfa_match.xlsx'
    lookUpTab = 'bfa_lookup_level3'
