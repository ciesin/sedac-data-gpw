...
if runFromToolBox:
    ...
    isoText = "usa_ri"
    inputPopTable = r'\\dataserver0\gpw\GPW4\Gridding\country\inputs\usa_state\states_variables\usa_ri.gdb\usa_ri_admin5_2010_input_population'
    ingestPopTab = None
    ingestPopLevel = 5
    estimateYear = "2010"
...
for description, table in tables.iteritems():
    ...
    if custom.checkForField(outPop1Tbl,'ISO')==0:
        try:
            arcpy.AddField_management(outPop1Tbl,'ISO','TEXT','#','#',10)
