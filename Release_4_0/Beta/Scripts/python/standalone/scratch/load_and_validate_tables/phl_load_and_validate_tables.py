...
if runFromToolBox:
    ...
    isoText = "PHL"
    inputPopTable = r'\\Dataserver0\gpw\GPW4\Beta\Preprocessing\Country\PHL\Ingest\Census\PHL_admin3_2010_ingest.xlsx'
    ingestPopTab = "PHL_admin3_census_2010"
    ingestPopLevel = 3
    estimateYear = "2010"
    yearField = "CENSUS_YEAR"
    inputSexTable = r'\\Dataserver0\gpw\GPW4\Beta\Preprocessing\Country\PHL\Ingest\Census\PHL_admin0_census_2010_sex.xlsx'
    ingestSexTab = "phl_admin0_census_2010"
    ingestSexLevel = 0
    inputAgeTable = None
    ingestAgeTab = None
    ingestAgeLevel = None
    ...
    lookUpTable = r'\\Dataserver0\gpw\GPW4\Beta\Preprocessing\Country\PHL\Match\PHL_match.xlsx'
    lookUpTab = 'phl_2010_admin3_match'
