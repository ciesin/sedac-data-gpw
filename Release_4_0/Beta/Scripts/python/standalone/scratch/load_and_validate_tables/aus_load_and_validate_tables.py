...
if runFromToolBox:
    ...
    isoText = "AUS"
    inputPopTable = r'\\Dataserver0\gpw\GPW4\Beta\Preprocessing\Country\AUS\Ingest\Census\AUS_2011_ingest_final_tab_only.xlsx'
    ingestPopTab = "AUS_admin5_census_2011"
    ingestPopLevel = 5
    estimateYear = "2011"
    yearField = "CENSUS_YEAR"
    inputSexTable = r'\\Dataserver0\gpw\GPW4\Beta\Preprocessing\Country\AUS\Ingest\Census\AUS_2011_ingest_final_tab_only.xlsx'
    ingestSexTab = "AUS_admin5_census_2011"
    ingestSexLevel = 5
    inputAgeTable = None
    ingestAgeTab = None
    ingestAgeLevel = None
