...
ingestParameters = r'\\Dataserver0\gpw\GPW4\Beta\Gridding\ancillary.gdb\ingest_parameters_8_17_15_9'
...
with arcpy.da.SearchCursor(ingestParameters,"*") as rows:
    for row in rows:
        ...
        inputGDB = workspace + os.sep + iso + ".gdb"
