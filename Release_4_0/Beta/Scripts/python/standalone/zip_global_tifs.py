...
datadir = r'\\Dataserver0\gpw\GPW4\Beta\Gridding\global\rasters\global_tifs'
outputws = r'\\Dataserver0\gpw\GPW4\Beta\Gridding\global\rasters\global_zips'
...
# define doc variabls
docws = r'\\Dataserver0\gpw\GPW4\Beta\Gridding\global\rasters\gpw-v4-documentation' 
...
for folder in workspaces:
    ...
    for raster in rasters:
        ...
        # create zipFile
        outZip = outputws + os.sep + raster.replace('tif','zip')
